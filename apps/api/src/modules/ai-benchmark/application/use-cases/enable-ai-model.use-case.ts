...
export type EnableAiModelCommand = Readonly<{
...
@Injectable()
export class EnableAiModelUseCase {
  constructor(
  ...
  async execute(command: EnableAiModelCommand): Promise<AiModelSummary> {
