...
export const CreatePricingScheduleBodySchema = z.object({
...
export const ExtractPricingScheduleVersionBodySchema = z.object({
...
export const SetPricingScheduleLineUnitPriceBodySchema = z.object({
...
export const SetPricingScheduleLineCostBreakdownBodySchema = z.object({
  costBreakdown: z
    .object({
...
export const SetPricingScheduleLineCommentBodySchema = z.object({
...
export const ValidatePricingScheduleVersionBodySchema = z.object({
