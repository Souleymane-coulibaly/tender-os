...
export class RemoveMembershipUseCase {
  ...
  async execute(command: RemoveMembershipCommand): Promise<void> {
    assertHasPermission(command.actorRole, OrganizationPermission.MemberRemove);
