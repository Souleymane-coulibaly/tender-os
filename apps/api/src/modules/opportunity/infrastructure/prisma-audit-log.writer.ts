...
export class PrismaAuditLogWriter implements AuditLogWriter {
  ...
  async record(entry: OpportunityAuditLogEntry): Promise<void> {
    // V2 Sprint 5 — rejoint la transaction ambiante active (ex. PromoteOpportunityToTenderUseCase)
    // si présente, voir PrismaService.currentClient() (V2 Sprint 4 round 4).
