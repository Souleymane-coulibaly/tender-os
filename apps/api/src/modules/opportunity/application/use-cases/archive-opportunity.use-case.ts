...
export type ArchiveOpportunityCommand = Readonly<{
...
export class ArchiveOpportunityUseCase {
  ...
  async execute(command: ArchiveOpportunityCommand): Promise<OpportunitySummary> {
    ...
    opportunity.changeStatus(OpportunityStatus.Archived, occurredAt);
