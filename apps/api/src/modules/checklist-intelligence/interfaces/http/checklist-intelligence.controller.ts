...
export class ChecklistIntelligenceController {
  ...
  @Get(":tenderId/checklist/freshness")
  @HttpCode(HttpStatus.OK)
  async freshness(
    @CurrentActor() actor: AuthenticatedActor,
    @CurrentMembershipContext() membership: MembershipContext,
    ...
    return this.getChecklistFreshnessUseCase.execute({ organizationId: membership.organizationId, tenderId, actorId: actor.userId, actorRole: membership.role });
  }
}
