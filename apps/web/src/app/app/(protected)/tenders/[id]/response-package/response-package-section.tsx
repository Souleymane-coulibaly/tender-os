...
function PackageDetail({ tenderId, detail, onRefresh }: { tenderId: string; detail: DetailState; onRefresh: () => Promise<void> }) {
        ...
        <div className="flex flex-col gap-4 lg:flex-row">
          ...
          <div className="flex-1">
            {isLoading ? (
              ...
              <PackageDetail tenderId={tenderId} detail={detail} onRefresh={() => loadDetail(detail.responsePackage.id)} />
            ) : (
