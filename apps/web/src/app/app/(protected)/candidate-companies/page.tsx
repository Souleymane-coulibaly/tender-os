  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={
          <div data-tour="guide-candidate-companies-create" className="flex">
      ...
      <div data-tour="guide-candidate-companies-list">
        {page.items.length === 0 ? (
          <EmptyState
          ...
          <div data-tour="guide-candidate-companies-open">
            <Table>
              <TableHead>
                <TableRow>
